...
export default function MenuItem({ item }: Props) {
  ...
  return (
    <Link href={`/menu/${id}`}>
      <div
        key={id}
        className='w-full bg-orange-50  max-w-sm border border-gray-200 rounded-lg shadow mx-auto my-4 sm:m-4 shadow-orange-500/50 hover:shadow-orange-500/100 transition duration-300 ease-in-out transform sm:hover:-translate-y-1 sm:hover:scale-105'
      >
        <Image
          src={image}
          alt={name}
